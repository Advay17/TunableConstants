...
public class TunablePIDController extends Tunable<PIDController> {
  ...
  public void reload() {
    target.setPID(
        Preferences.getDouble(name + "kP", target.getP()),
        Preferences.getDouble(name + "kI", target.getI()),
        Preferences.getDouble(name + "kD", target.getD()));
    target.setTolerance(
        Preferences.getDouble(name + "tolerance", target.getErrorTolerance()),
        Preferences.getDouble(
            name + "errorDerivativeTolerance", target.getErrorDerivativeTolerance()));
  }
}
